...
QString ReportBackend::selectedClientId() const { return m_currentClient.id; }
QString ReportBackend::selectedClientName() const { return m_currentClient.name; }
QString ReportBackend::selectedObjectName() const { return m_currentObject.name; }
int ReportBackend::selectedObjectLastOrder() const { return static_cast<int>(m_currentObject.lastOrderAt); }
int ReportBackend::selectedStartOrderAt() const { return m_selectedStartOrderAt; }
int ReportBackend::selectedOrderTotalPrice() const { return m_selectedOrderTotalPrice; }
QString ReportBackend::currentServiceName() const { return m_currentService.name; }
int ReportBackend::currentPrice() const { return m_currentService.price; }
QString ReportBackend::currentCoefficients() const { return m_currentService.coefficients; }
int ReportBackend::currentPercentSum() const { return m_currentService.percentSum; }
QString ReportBackend::currentSubObject() const { return m_currentService.subObject; }
QString ReportBackend::lastReportPath() const { return m_lastReportPath; }
QString ReportBackend::lastReportUrl() const { return m_lastReportUrl; }

ClientsModel *ReportBackend::clientsModel() const { return const_cast<ClientsModel *>(&m_clients); }
ObjectsModel *ReportBackend::objectsModel() const { return const_cast<ObjectsModel *>(&m_objects); }
OrdersModel *ReportBackend::ordersModel() const { return const_cast<OrdersModel *>(&m_orders); }
WorksModel *ReportBackend::worksModel() const { return const_cast<WorksModel *>(&m_works); }
WorksModel *ReportBackend::workReportModel() const { return const_cast<WorksModel *>(&m_workReport); }
SubobjectsModel *ReportBackend::subobjectsModel() const { return const_cast<SubobjectsModel *>(&m_subobjects); }
SubobjectsFilterModel *ReportBackend::subobjectsFilterModel() const
{
    return const_cast<SubobjectsFilterModel *>(&m_subobjectsFilter);
}
